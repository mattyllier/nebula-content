...
for(let i = 0; i < names.length; i++){
    for(let j = names[i]; j < names[i].length; j++){
        if (j.includes('a')){
            console.log(j)
        }
    }
...
for(let i = 0; i < stringArray.length; i++){
    for(let j = stringArray[i]; j < stringArray[i].length; j++){
        if (j % 2 === 0){
            newArr1.push(j.toUpperCase)
        } else{
            newArr1.push(j)
        }
    }
...
for(let i = 0; i < arrayOfArrays.length; i++){
    for(let j = arrayOfArrays[i]; j < arrayOfArrays[i].length; j+=j){
        values.push(j)
    }
}
console.log(values)
