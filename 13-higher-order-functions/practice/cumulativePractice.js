...
console.log(people.sort((a,b)=>a.birthYear-b.birthYear))
...
console.log(cars.filter(a=>a.make<2000))
...
console.log(nums1.forEach(a=>a>1000 ? console.log(`That's a big number!`):console.log(`This number isn't so big...`)))
...
console.log(peopleArray.filter(a=>a.length>5))
...
console.log(people1.filter(a=>a.age>20&&a.age<35).sort((a,b)=>a.age-b.age))
